...
public class ProgramState {
    ...
    public ProgramState(IExecutionStack<IStatement> executionStack, IDictionary<String, Value> symbolTable, 
                        ...
                        ILockTable<Integer> lockTable, IStatement program) {
    ...
    public ILockTable<Integer> getLockTable() { return this.lockTable; }

    public void setLockTable(ILockTable<Integer> lockTable) { this.lockTable = lockTable; }
