...
import com.example.toylanguage_intellij.Model.ProgramStateComponents.FileTable;
import com.example.toylanguage_intellij.Model.ProgramStateComponents.Heap;
...
import com.example.toylanguage_intellij.Model.ProgramStateComponents.OutputList;
...
public class SelectProgramController{
    ...
    private static ProgramState createProgramState(IStatement statement) {
        ...
        return new ProgramState(stack, symbolTable, outputList, fileTable, heap, statement);
    }
