...
public class RunProgramController {
    ...
    @FXML
    public TableView<LockTableEntry> lockTableView;

    @FXML
    public TableColumn<LockTableEntry, String> lockLocationColumn;

    @FXML
    public TableColumn<LockTableEntry, String> lockValueColumn;
    ...
    public void setSelectedController(Controller selectedController) {
        ...
        this.lockLocationColumn.setCellValueFactory(new PropertyValueFactory<>("location"));
        ...
        ILockTable<Integer> lockTable = this.selectedProgram.getLockTable();
        ...
        lockTable.getContent().forEach((location, value)->this.lockTableView.getItems().add(new LockTableEntry(location, value)));
    ...
    synchronized void showDataForSelectedPrgState(ProgramState selectedProgram){
        ...
        selectedProgram.getLockTable().getContent().forEach((location, value)->this.lockTableView.getItems().add(new LockTableEntry(location, value)));
